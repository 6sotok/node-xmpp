...
function selectMechanism(offeredMechs, preferredMech, availableMech) {
    var mechClasses = [XOAuth2, XYandexOAuth, XFacebookPlatform, DigestMD5,
		       Plain, Anonymous];
    var byName = {};
    var mech;
...
util.inherits(XYandexOAuth, Mechanism);
XYandexOAuth.prototype.name = "X-YANDEX-OAUTH";
XYandexOAuth.prototype.auth = function() {
    return this.authzid.split("@")[0] + "\0" + this.oauth2_token;
};
XYandexOAuth.prototype.authAttrs = function() {
    return {};
};
